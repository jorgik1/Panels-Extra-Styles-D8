...
class RawStyle extends PanelsStyleBase implements ContainerFactoryPluginInterface {
  ...
  public function buildBlock(PanelsDisplayVariant $display, BlockPluginInterface $block) {
    ...
    if (is_array($config) && !empty($config['style']['configuration']['pane']['content']['prefix']) && !empty($config['style']['configuration']['pane']['content']['suffix'])) {
      $build['content'] = [
    ...
    if (is_array($config) && $config['style']['configuration']['pane']['content']['prefix'] === '' && $config['style']['configuration']['pane']['content']['suffix'] === '') {
      $build['content'] = [
        '#type' => 'markup',
        '#markup' => $this->renderer->render($render_array),
      ];
